...
const REGION_KPI_DEFS = [
  {no:37, icon:"bi-geo-alt-fill",        labelKey:"kpi_mahalla",   unitKey:"unit_ta"},
  {no:39, icon:"bi-house-door-fill",     labelKey:"kpi_xonadon",   unit:""},
  {no:38, icon:"bi-people",              labelKey:"kpi_oila",      unit:""},
  {no:36, icon:"bi-people-fill",         labelKey:"kpi_aholi",     unitKey:"unit_ming_kishi"},
...
function buildRegionInsights(district){
  ...
  const mah = kpiFromIndicator(data, 37, {});
  const xon = kpiFromIndicator(data, 39, {});
  const oila = kpiFromIndicator(data, 38, {});
