...
├── api/openai-proxy.js                — Vercel serverless proxy
├── functions/api/openai-proxy.js      — Cloudflare Pages proxy
└── netlify/functions/openai-proxy.js  — Netlify proxy
```
...
| Платформа | URL | Ҳолат |
|-----------|-----|-------|
| **Cloudflare** | https://sqb-dashboard.pages.dev | Асосий |
| **Vercel** | https://sqb-buxoro-dashboard.vercel.app | Захира |
| **GitHub** | https://github.com/u-specter/sqb-buxoro-dashboard | Код |
...
- Деплой: Cloudflare Pages / Vercel / Netlify
